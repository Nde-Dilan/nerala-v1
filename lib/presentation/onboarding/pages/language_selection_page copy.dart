  ...
  Future<void> _handleLanguageSelection() async {
    ...
    if (isGoogleUser) {
      ...
      try {
        ...
        if (mounted) {
          showErrorDialog(
              context, "Update Error", "Failed to update language preference");
        }
      }
    } else {
      // Normal signup flow
      widget.userCreationReq.learningLanguage = _selectedLanguage?.name;
      context
          .read<ButtonStateCubit>()
          .execute(usecase: SignupUseCase(), params: widget.userCreationReq);
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _LanguageSelectionContent(
        ...
        handleLanguageSelection: _handleLanguageSelection,
      ),
    );
  }
}
...
class _LanguageSelectionContent extends StatelessWidget {
  ...
  final Future<void> Function() handleLanguageSelection;

  const _LanguageSelectionContent({
    required this.userCreationReq,
    required this.selectedLanguage,
    required this.onLanguageSelected,
    required this.handleLanguageSelection,
  });

  void showLanguageInfo(BuildContext context, Language language) {
    showDialog(
      context: context,
    ...
    return BlocBuilder<ButtonStateCubit, ButtonState>(
      builder: (context, state) {
        if (state is ButtonLoadingState) {
          ...
          showErrorDialog(context, "Sign Up Error", state.errorMessage);
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return LanguageCard(
                          ...
                          onInfoTap: () =>
                              showLanguageInfo(context, language),
                        );
                      },
                    ),
                  ),
